...
hidden if the `cpp-serializer_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `cpp-serializer_DEVELOPER_MODE` to the configure
